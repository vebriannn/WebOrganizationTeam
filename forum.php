...
<head>
  ...
  <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet" />
  <link href="style/forum.css?v=<?php echo time(); ?>" rel="stylesheet" />
...
<body>
  ...
  <div class="page-content page-home">
    ...
    <section class="section2">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7">
            <textarea name="" id="" cols="20" rows="10" placeholder="Start a Question..." ></textarea>
    ...
    <script src="script/forum.js?v=<?php echo time(); ?>"></script>
    <script>
      AOS.init();
    </script>
    <!-- <script>
